        ...
        <div
            ...
            <div className="widdd">
                <div className="pb-5">
                    ...
                    <p className="text-justify">Hello Human, it's me, Zhivko! My favorite data structure is Bloom Filter, and you? Perfect. Nice
                        to meet you.
                    </p>
                </div>
                ...
                <div className="pb-5 ">
                    ...
                    <p className="text-justify">Since my early days in school, I have developed a passion for system security and integrity.
                ...
                <div className="pb-5">
                    ...
                    <p className="text-justify">I strive for simplicity and clarity in my programming endeavors, adhering to the KISS principle,
                ...
                <div>
                    ...
                    <p className="text-justify">Have any questions? Not a problem at all, just send me an email, I tend to respond as soon as I
