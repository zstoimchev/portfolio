    ...
    return (
        ...
        >
            <div className="max-w-4xl">
                <h2 className="text-4xl md:text-6xl font-bold mb-12 text-emerald-400">
                    {'>'}_system_profile
                </h2>
                ...
                <div className="space-y-8">
                    ...
                    <div className="border-l-4 border-emerald-600 pl-6 hover:border-cyan-400 transition-colors">
                        <h3 className="text-2xl md:text-3xl mb-3 text-cyan-400">
                            {'//'} Background
                        </h3>
                ...
                {/* Tech Stack */}
                <div className="mt-16">
                    <h3 className="text-3xl md:text-4xl mb-6 text-emerald-400">
                        {'//'} Tech Stack
                    </h3>
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
                        {techStack.map(tech => (
                            ...
                            >
                                <span className="text-md md:text-lg text-gray-400">{tech}</span>
                            </div>
                        ))}
                    </div>
                </div>
